 ...
 */
  ...
  var salario = parseInt(prompt("Ingrese su salario actual    solo números"))
                         
  var propiedades = prompt("¿Tiene propiedades a su nombre ?  si/no")
  if("SI" == propiedades.toUpperCase()){
    var cantidad_propiedades = prompt("¿Cuántas propiedades tiene en total?")
    }
 ...
 */ 
  ...
  recargo_total = recargo_total + recargo
  alert("Recargo del 5% en base a su salario    Q. "+recargo)
  
  //recargo de propiedades
  if(cantidad_propiedades>0){
  recargo = (precio_base * propiedad_recargo) * cantidad_propiedades
  recargo_total = recargo_total + recargo
  alert("Recargo del 35% por cada uno de sus propiedades    Q. "+recargo)
  }
...
//Resultado
  ...
  if(opcion != "salir"){
    opcion = prompt("Si desea finalizar escriba salir, si desea realizar una nueva cotización presione enter" )
  }else{
